...
public final class PackageUsedByPage implements lahaina.runtime.Page {

	public void PackageUsedByPage() {}
	...
	public void process(lahaina.runtime.Writer out, lahaina.runtime.State state) throws Exception {
		...
		out.write("<TD><B>(Package ");
		out.write(state.getStringAttribute("this.displayName"));
		out.write(")</B></TD><TD><B>Used by (Package ");
